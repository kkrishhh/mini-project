-- Create the user_scrapes table with analytics
create table if not exists public.user_scrapes (
...
create index if not exists user_scrapes_user_id_idx on public.user_scrapes(user_id);
create index if not exists user_scrapes_domain_idx on public.user_scrapes(domain);
create index if not exists user_scrapes_scraped_at_idx on public.user_scrapes(scraped_at); 